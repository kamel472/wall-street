        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 text-center">
              <h1>About Us</h1>
              <p>Wall Street Group provide a real estate services through a professional team to help you choosing what suits you in the real estate market.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto">
            <h2>Our Mission</h2>
            <p>TO BECOME THE LEADING REAL ESTATE COMPANY IN AFRICA PROVIDING WORLD CLASS REAL ESTATE SERVICES THAT MEET OUR 
            CLIENTS NEEDS AT ALL TIMES.</p>

            <h2>Our Vision</h2>
            <p>We exist to provide  world- class services in the area of our core competences that leave our 
            clients happy and thoroughly satisfied.</p>
          </div>
